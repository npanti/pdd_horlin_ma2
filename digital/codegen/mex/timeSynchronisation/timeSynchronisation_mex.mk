...
MAKEFILE = timeSynchronisation_mex.mk

include timeSynchronisation_mex.mki


SRC_FILES =  \
	timeSynchronisation_mexutil.c \
	timeSynchronisation_data.c \
	timeSynchronisation_initialize.c \
	timeSynchronisation_terminate.c \
	timeSynchronisation.c \
	signalPower.c \
	abs.c \
	timeSynchronisation_api.c \
	timeSynchronisation_emxutil.c \
	timeSynchronisation_mex.c

MEX_FILE_NAME_WO_EXT = timeSynchronisation_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/timeSynchronisation"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/timeSynchronisation/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/timeSynchronisation/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/timeSynchronisation/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
