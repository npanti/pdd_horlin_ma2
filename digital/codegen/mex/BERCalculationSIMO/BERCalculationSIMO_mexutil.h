...
#ifndef __BERCALCULATIONSIMO_MEXUTIL_H__
#define __BERCALCULATIONSIMO_MEXUTIL_H__
/* Include files */
#include <math.h>
#include <stdlib.h>
#include <string.h>
...
#endif
/* End of code generation (BERCalculationSIMO_mexutil.h) */
