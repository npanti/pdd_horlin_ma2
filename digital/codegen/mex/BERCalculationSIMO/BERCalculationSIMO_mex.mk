...
MAKEFILE = BERCalculationSIMO_mex.mk

include BERCalculationSIMO_mex.mki


SRC_FILES =  \
	BERCalculationSIMO_mexutil.c \
	BERCalculationSIMO_data.c \
	BERCalculationSIMO_initialize.c \
	BERCalculationSIMO_terminate.c \
	BERCalculationSIMO.c \
	fprintf.c \
	BERCalculationSIMO_api.c \
	BERCalculationSIMO_emxutil.c \
	BERCalculationSIMO_mex.c

MEX_FILE_NAME_WO_EXT = BERCalculationSIMO_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/BERCalculationSIMO"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/BERCalculationSIMO/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/BERCalculationSIMO/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/BERCalculationSIMO/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
