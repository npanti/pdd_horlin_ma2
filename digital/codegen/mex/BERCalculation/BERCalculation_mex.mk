...
MAKEFILE = BERCalculation_mex.mk

include BERCalculation_mex.mki


SRC_FILES =  \
	BERCalculation_mexutil.c \
	BERCalculation_data.c \
	BERCalculation_initialize.c \
	BERCalculation_terminate.c \
	BERCalculation.c \
	fprintf.c \
	BERCalculation_api.c \
	BERCalculation_emxutil.c \
	BERCalculation_mex.c

MEX_FILE_NAME_WO_EXT = BERCalculation_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/BERCalculation"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/BERCalculation/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/BERCalculation/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/BERCalculation/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
