 ...
 *
 * Code generation for function 'timeSynchronisationSIMO_api'
 *
...
static emlrtRTEInfo h_emlrtRTEI = { 1, 1, "timeSynchronisationSIMO_api", "" };
...
{
  info[0].context =
    "[E]/Users/nicolas/Documents/MATLAB/pdd_horlin_ma2/digital/timeSynchronisationSIMO.m";
  info[0].name = "length";
...
void timeSynchronisationSIMO_api(const mxArray * const prhs[1], const mxArray
  *plhs[1])
{
  ...
  b_index = timeSynchronisationSIMO(input);
...
/* End of code generation (timeSynchronisationSIMO_api.c) */
